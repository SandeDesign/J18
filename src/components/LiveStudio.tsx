...
export default function LiveStudio() {
  ...
  return (
    <section className="py-24 px-4 bg-gradient-to-b from-purple-950/20 to-black">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 mb-4">
            <Radio className={`w-8 h-8 ${isLive ? 'text-red-500 animate-pulse' : 'text-purple-400'}`} />
            <h2 className="text-6xl font-bold neon-glow">Live Studio</h2>
          </div>
          <p className="text-xl text-gray-400">Watch beats being made in real-time</p>
        </div>
